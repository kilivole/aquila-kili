 ...
 * @package AquilaKili
 */
$menu_class = \AquilaKili_Theme\Inc\Menus::get_instance();
$header_menu_id = $menu_class->get_menu_id( 'aquilakili-header-menu');
          ...
          <?php 
            foreach ( $header_menus as $menu_item) {
              if ( ! $menu_item->menu_item_parent) {
                ...
                $has_children = ! empty( $child_menu_items ) && is_arry( $child_menu_items );
